...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-cyan-500 to-sky-500 hover:from-cyan-600 hover:to-sky-600 text-slate-950 shadow-md shadow-cyan-500/15',
    secondary: 'bg-slate-800 hover:bg-slate-750 text-slate-100 border border-slate-700/60',
